    ...
    <div class="col-sm-12">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <?php echo $this->Form->create('User', array('url' => array('controller' => 'users', 'action' => 'edit', 'admin' => true, $id), 'class' => 'smart-wizard form-horizontal', 'id' => 'addUsersForm', 'novalidate'=>'true', 'type' => 'file','inputDefaults' => array('errorMessage' => true))); ?>
                ...
                <div id="wizard" class="swMain">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <?php echo $this->Form->input('User.user_email', array('label' => false, 'class' => 'form-control', 'id' => 'email_id', 'placeholder'=>'User Email', 'disabled'=>true));?>
                        </div>
                    </div>
